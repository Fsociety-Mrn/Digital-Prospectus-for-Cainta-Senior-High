Public Class Gafd
    ...
    Private Sub PrintDocument1_PrintPage_1(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim r As New Rectangle(720, 30, 60, 60) 'Left CSHS
        Dim rr As New Rectangle(80, 30, 60, 60) 'Right DEPED
        ...
        End If
        e.Graphics.DrawString("DATE: " + Date.Now.ToString("MM/dd/yyyy") + vbNewLine + "TVL - GAFD", font2, Brushes.Black, 660, 90)
        ...
        Try
            ...
            If CheckBox23.Checked = False Then
                e.Graphics.DrawString("   • Dress Making", font1, Brushes.Black, 60, 980)
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox54.Text, font1, Brushes.Black, 655, 980)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 980)
            End If

            If CheckBox24.Checked = False Then
                e.Graphics.DrawString("   • Tailoring", font1, Brushes.Black, 60, 1000)
            ...
            If CheckBox25.Checked = False Then
                e.Graphics.DrawString("   • Fashion Design Apparel", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1020)
            ElseIf TextBox29.Text = "" Then
                e.Graphics.DrawString("  • Fashion Design Apparel", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1020)
                e.Graphics.DrawString(TextBox56.Text, font1, Brushes.Black, 655, 1020)
            ElseIf TextBox56.Text = "" Then
                e.Graphics.DrawString("  • Fashion Design Apparel", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1020)
                e.Graphics.DrawString(TextBox29.Text, font1, Brushes.Black, 700, 1020)
            Else
                ...
                e.Graphics.DrawString(TextBox29.Text, font1, Brushes.Black, 700, 1020)
                e.Graphics.DrawString("  • Fashion Design Apparel", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("               T   A    K    E    N", font1, Brushes.Black, 405, 1020)
                e.Graphics.DrawString(TextBox56.Text, font1, Brushes.Black, 655, 1020)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 1020)
            End If
            ''immersion box
