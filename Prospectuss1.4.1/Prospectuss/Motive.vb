Public Class Motive
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim BOX As New Rectangle(51, 215, 744, 960) 'WHOLE BOX
        ...
        Dim V1box As New Rectangle(650, 215, 145, 960) 'first Vertical Box
        ...
        Dim VV3box As New Rectangle(695, 964, 44, 91) 'third vertical box
        ...
        e.Graphics.DrawLine(Pens.Black, 395, 215, 395, 1175) 'Line to First Box to Third Box
        ...
        e.Graphics.DrawString("___________", font1, Brushes.Black, 649, 218) ' naghahati sa quarter at 1wst at second
        Try
            ...
            If CheckBox23.Checked = False Then
                e.Graphics.DrawString("   • Automotive Servicing (NC1)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 980)
            ElseIf TextBox27.Text = "" Then
                e.Graphics.DrawString("  •  Automotive Servicing (NC1)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 980)
                e.Graphics.DrawString(TextBox54.Text, font1, Brushes.Black, 655, 980)
            ElseIf TextBox54.Text = "" Then
                e.Graphics.DrawString("  • Automotive Servicing (NC1)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 980)
                e.Graphics.DrawString(TextBox27.Text, font1, Brushes.Black, 700, 980)
            Else
                ...
                e.Graphics.DrawString(TextBox27.Text, font1, Brushes.Black, 700, 980)
                e.Graphics.DrawString("  • Automotive Servicing (NC1)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("               T   A    K    E    N", font1, Brushes.Black, 405, 980)
                e.Graphics.DrawString(TextBox54.Text, font1, Brushes.Black, 655, 980)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 760, 980)
            End If

            If CheckBox24.Checked = False Then
                e.Graphics.DrawString("   • Automotive Servicing (NC2)", font1, Brushes.Black, 60, 1000)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1000)
            ElseIf TextBox28.Text = "" Then
                e.Graphics.DrawString("  • Automotive Servicing (NC2)", font1, Brushes.Black, 60, 1000)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1000)
                e.Graphics.DrawString(TextBox55.Text, font1, Brushes.Black, 655, 1000)
            ElseIf TextBox55.Text = "" Then
                e.Graphics.DrawString("  • Automotive Servicing (NC2)", font1, Brushes.Black, 60, 1000)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1000)
                e.Graphics.DrawString(TextBox28.Text, font1, Brushes.Black, 700, 1000)
            Else
                ...
                e.Graphics.DrawString(TextBox55.Text, font1, Brushes.Black, 655, 1000)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 760, 1000)
            End If
            ''immersion box
            e.Graphics.DrawLine(Pens.Black, 51, 1055, 795, 1055) ''immersion box
            e.Graphics.DrawString("Date: mm/dd/yyyy ", font1, Brushes.Black, 450, 1075)
            e.Graphics.DrawString("No. of " + vbNewLine + "Hours", font1, Brushes.Black, 660, 1065)
            e.Graphics.DrawString("Final " + vbNewLine + "Grade", font1, Brushes.Black, 730, 1065)
            e.Graphics.DrawLine(Pens.Black, 395, 1105, 795, 1105)
            e.Graphics.DrawLine(Pens.Black, 720, 1055, 720, 1175) 'vertical Line

            If CheckBox29.Checked = False Then
                e.Graphics.DrawString("   • WORK IMMERSION", font1, Brushes.Black, 60, 1115)
                e.Graphics.DrawString("Start :" + " _____________________", font1, Brushes.Black, 405, 1125)
                e.Graphics.DrawString(" End : " + "_____________________", font1, Brushes.Black, 405, 1145)
            Else
                e.Graphics.DrawString("   • WORK IMMERSION", font1, Brushes.Black, 60, 1115)
                e.Graphics.DrawString("Start : " + DateTimePicker1.Text, font1, Brushes.Black, 450, 1125)
                e.Graphics.DrawString(" End : " + DateTimePicker1.Text, font1, Brushes.Black, 450, 1145)
                e.Graphics.DrawString(TextBox63.Text, font1, Brushes.Black, 655, 1135)
                e.Graphics.DrawString(TextBox64.Text, font1, Brushes.Black, 750, 1135)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Label15.SetBounds(450, 300, 80, 30)
    ...
    Private Sub Button6_Click_1(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        'Subjects and Quarter
        Label15.Visible = True
        Label15.SetBounds(537, 301, 80, 30)
    ...
    Private Sub TextBox2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox9.KeyPress, TextBox8.KeyPress, TextBox7.KeyPress, TextBox6.KeyPress, TextBox55.KeyPress, TextBox54.KeyPress, TextBox53.KeyPress, TextBox52.KeyPress, TextBox51.KeyPress, TextBox50.KeyPress, TextBox5.KeyPress, TextBox49.KeyPress, TextBox48.KeyPress, TextBox47.KeyPress, TextBox44.KeyPress, TextBox42.KeyPress, TextBox41.KeyPress, TextBox40.KeyPress, TextBox39.KeyPress, TextBox38.KeyPress, TextBox37.KeyPress, TextBox36.KeyPress, TextBox35.KeyPress, TextBox34.KeyPress, TextBox33.KeyPress, TextBox32.KeyPress, TextBox31.KeyPress, TextBox30.KeyPress, TextBox28.KeyPress, TextBox27.KeyPress, TextBox26.KeyPress, TextBox25.KeyPress, TextBox24.KeyPress, TextBox23.KeyPress, TextBox22.KeyPress, TextBox21.KeyPress, TextBox20.KeyPress, TextBox19.KeyPress, TextBox17.KeyPress, TextBox16.KeyPress, TextBox15.KeyPress, TextBox14.KeyPress, TextBox13.KeyPress, TextBox12.KeyPress, TextBox11.KeyPress, TextBox10.KeyPress
    ...
    Private Sub CheckBox14_CheckedChanged_2(sender As Object, e As EventArgs) Handles CheckBox14.CheckedChanged
    ...
    Private Sub CheckBox15_CheckedChanged_2(sender As Object, e As EventArgs) Handles CheckBox15.CheckedChanged
