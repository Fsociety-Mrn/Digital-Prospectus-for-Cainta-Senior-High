Public Class Elect
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("              Senior High School " + vbNewLine +
                              "                Core Curriculum", font1, Brushes.Black, 60, 220)
        ...
        e.Graphics.DrawString("___________", font1, Brushes.Black, 650, 218) ' naghahati sa quarter at 1wst at second
        Try
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox5.Text, font1, Brushes.Black, 700, 280)
                e.Graphics.DrawString(TextBox30.Text, font1, Brushes.Black, 655, 280)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 280)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox6.Text, font1, Brushes.Black, 700, 300)
                e.Graphics.DrawString(TextBox31.Text, font1, Brushes.Black, 655, 300)
                e.Graphics.DrawString(cc3, font1, Brushes.Black, 755, 300)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox7.Text, font1, Brushes.Black, 700, 340)
                e.Graphics.DrawString(TextBox32.Text, font1, Brushes.Black, 655, 340)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 340)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox8.Text, font1, Brushes.Black, 700, 380)
                e.Graphics.DrawString(TextBox33.Text, font1, Brushes.Black, 655, 380)
                e.Graphics.DrawString(c4, font1, Brushes.Black, 755, 380)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox9.Text, font1, Brushes.Black, 700, 420)
                e.Graphics.DrawString(TextBox34.Text, font1, Brushes.Black, 655, 420)
                e.Graphics.DrawString(c5, font1, Brushes.Black, 755, 420)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox10.Text, font1, Brushes.Black, 700, 460)
                e.Graphics.DrawString(TextBox35.Text, font1, Brushes.Black, 655, 460)
                e.Graphics.DrawString(c6, font1, Brushes.Black, 755, 460)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox11.Text, font1, Brushes.Black, 700, 480)
                e.Graphics.DrawString(TextBox36.Text, font1, Brushes.Black, 655, 480)
                e.Graphics.DrawString(c7, font1, Brushes.Black, 755, 480)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox12.Text, font1, Brushes.Black, 700, 500)
                e.Graphics.DrawString(TextBox37.Text, font1, Brushes.Black, 655, 500)
                e.Graphics.DrawString(c8, font1, Brushes.Black, 755, 500)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox13.Text, font1, Brushes.Black, 700, 520)
                e.Graphics.DrawString(TextBox38.Text, font1, Brushes.Black, 655, 520)
                e.Graphics.DrawString(c9, font1, Brushes.Black, 755, 520)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox14.Text, font1, Brushes.Black, 700, 540)
                e.Graphics.DrawString(TextBox39.Text, font1, Brushes.Black, 655, 540)
                e.Graphics.DrawString(c10, font1, Brushes.Black, 755, 540)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox15.Text, font1, Brushes.Black, 700, 560)
                e.Graphics.DrawString(TextBox40.Text, font1, Brushes.Black, 655, 560)
                e.Graphics.DrawString(c11, font1, Brushes.Black, 755, 560)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox16.Text, font1, Brushes.Black, 700, 600)
                e.Graphics.DrawString(TextBox41.Text, font1, Brushes.Black, 655, 600)
                e.Graphics.DrawString(c12, font1, Brushes.Black, 755, 600)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox17.Text, font1, Brushes.Black, 700, 620)
                e.Graphics.DrawString(TextBox42.Text, font1, Brushes.Black, 655, 620)
                e.Graphics.DrawString(c13, font1, Brushes.Black, 755, 620)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox18.Text, font1, Brushes.Black, 700, 640)
                e.Graphics.DrawString(TextBox43.Text, font1, Brushes.Black, 655, 640)
                e.Graphics.DrawString(c14, font1, Brushes.Black, 755, 640)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox19.Text, font1, Brushes.Black, 700, 680)
                e.Graphics.DrawString(TextBox44.Text, font1, Brushes.Black, 655, 680)
                e.Graphics.DrawString(c15, font1, Brushes.Black, 755, 680)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox20.Text, font1, Brushes.Black, 700, 770)
                e.Graphics.DrawString(TextBox47.Text, font1, Brushes.Black, 655, 770)
                e.Graphics.DrawString(c16, font1, Brushes.Black, 755, 770)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox21.Text, font1, Brushes.Black, 700, 790)
                e.Graphics.DrawString(TextBox48.Text, font1, Brushes.Black, 655, 790)
                e.Graphics.DrawString(c17, font1, Brushes.Black, 755, 790)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox22.Text, font1, Brushes.Black, 700, 810)
                e.Graphics.DrawString(TextBox49.Text, font1, Brushes.Black, 655, 810)
                e.Graphics.DrawString(c18, font1, Brushes.Black, 755, 810)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox50.Text, font1, Brushes.Black, 655, 830)
                e.Graphics.DrawString(c19, font1, Brushes.Black, 755, 830)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox51.Text, font1, Brushes.Black, 655, 850)
                e.Graphics.DrawString(c20, font1, Brushes.Black, 755, 850)
            End If
            ...
            ElseIf TextBox25.Text = "" Then
                e.Graphics.DrawString("  • Entrepreneurship", font1, Brushes.Black, 60, 870)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 870)
                e.Graphics.DrawString(TextBox52.Text, font1, Brushes.Black, 655, 870)
            ElseIf TextBox52.Text = "" Then
                e.Graphics.DrawString("  • Entrepreneurship", font1, Brushes.Black, 60, 870)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 870)
                e.Graphics.DrawString(TextBox25.Text, font1, Brushes.Black, 700, 870)
            Else
                ...
                e.Graphics.DrawString(TextBox52.Text, font1, Brushes.Black, 655, 870)
                e.Graphics.DrawString(c21, font1, Brushes.Black, 755, 870)
            End If
            ...
            Else
                ...
                e.Graphics.DrawString(TextBox53.Text, font1, Brushes.Black, 655, 890)
                e.Graphics.DrawString(c22, font1, Brushes.Black, 755, 890)
            End If
            ...
            e.Graphics.DrawString("               Major Subjects ", font1, Brushes.Black, 60, 930)
            e.Graphics.DrawString("T I M E", T, Brushes.Black, 490, 925)
            ...
            If CheckBox23.Checked = False Then
                e.Graphics.DrawString("  • Electrical Instalation " + vbNewLine + "      and Maintenance (NC II)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1000)
            ElseIf TextBox27.Text = "" Then
                e.Graphics.DrawString("  • Electrical Instalation " + vbNewLine + "      and Maintenance (NC II)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1000)
                e.Graphics.DrawString(TextBox54.Text, font1, Brushes.Black, 655, 1000)
            ElseIf TextBox54.Text = "" Then
                e.Graphics.DrawString("  • Electrical Instalation " + vbNewLine + "      and Maintenance (NC II)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1000)
                e.Graphics.DrawString(TextBox27.Text, font1, Brushes.Black, 700, 1000)
            Else
                ...
                e.Graphics.DrawString("  • Electrical Instalation " + vbNewLine + "      and Maintenance (NC II)", font1, Brushes.Black, 60, 980)
                e.Graphics.DrawString(TextBox27.Text, font1, Brushes.Black, 700, 1000)
                e.Graphics.DrawString("               T   A    K    E    N", font1, Brushes.Black, 405, 1000)
                e.Graphics.DrawString(TextBox54.Text, font1, Brushes.Black, 655, 1000)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 1000)
            End If

            If CheckBox24.Checked = False Then
                e.Graphics.DrawString("  • Electric Power Distrubution " + vbNewLine + "      Line Construction (NC II)", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1040)
            ElseIf TextBox28.Text = "" Then
                e.Graphics.DrawString("  • Electric Power Distrubution " + vbNewLine + "      Line Construction (NC II)", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1040)
                e.Graphics.DrawString(TextBox55.Text, font1, Brushes.Black, 655, 1040)
            ElseIf TextBox55.Text = "" Then
                e.Graphics.DrawString("  • Electric Power Distrubution " + vbNewLine + "      Line Construction (NC II)", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1040)
                e.Graphics.DrawString(TextBox28.Text, font1, Brushes.Black, 700, 1040)
            Else
                ...
                e.Graphics.DrawString("  • Electric Power Distrubution " + vbNewLine + "      Line Construction (NC II)", font1, Brushes.Black, 60, 1020)
                e.Graphics.DrawString(TextBox28.Text, font1, Brushes.Black, 700, 1040)
                e.Graphics.DrawString("               T   A    K    E    N", font1, Brushes.Black, 405, 1040)
                e.Graphics.DrawString(TextBox55.Text, font1, Brushes.Black, 655, 1040)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 1040)
            End If

            If CheckBox25.Checked = False Then
                e.Graphics.DrawString("  • Electronic Products Assembly " + vbNewLine + "      and Servicing (NC II)", font1, Brushes.Black, 60, 1060)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1080)
            ElseIf TextBox29.Text = "" Then
                e.Graphics.DrawString("  • Electronic Products Assembly " + vbNewLine + "      and Servicing (NC II)", font1, Brushes.Black, 60, 1060)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1080)
                e.Graphics.DrawString(TextBox56.Text, font1, Brushes.Black, 655, 1080)
            ElseIf TextBox56.Text = "" Then
                e.Graphics.DrawString("  • Electronic Products Assembly " + vbNewLine + "      and Servicing (NC II)", font1, Brushes.Black, 60, 1060)
                e.Graphics.DrawString("_____________  |  _____________", font1, Brushes.Black, 405, 1080)
                e.Graphics.DrawString(TextBox29.Text, font1, Brushes.Black, 700, 1080)
            Else
                ...
                e.Graphics.DrawString(TextBox29.Text, font1, Brushes.Black, 700, 1080)
                e.Graphics.DrawString("  • Electronic Products Assembly " + vbNewLine + "      and Servicing (NC II)", font1, Brushes.Black, 60, 1060)
                e.Graphics.DrawString("               T   A    K    E    N", font1, Brushes.Black, 405, 1080)
                e.Graphics.DrawString(TextBox56.Text, font1, Brushes.Black, 655, 1080)
                e.Graphics.DrawString(c3, font1, Brushes.Black, 755, 1080)
            End If

            ''immersion box
            e.Graphics.DrawLine(Pens.Black, 51, 1115, 795, 1115) ''immersion box
            e.Graphics.DrawString("Date: mm/dd/yyyy ", font1, Brushes.Black, 450, 1135)
            e.Graphics.DrawString("No. of " + vbNewLine + "Hours", font1, Brushes.Black, 660, 1125)
            e.Graphics.DrawString("Final " + vbNewLine + "Grade", font1, Brushes.Black, 730, 1125)
            e.Graphics.DrawLine(Pens.Black, 395, 1165, 795, 1165)
            e.Graphics.DrawLine(Pens.Black, 720, 1115, 720, 1245) 'vertical Line

            If CheckBox29.Checked = False Then
                e.Graphics.DrawString("   • WORK IMMERSION", font1, Brushes.Black, 60, 1175)
                e.Graphics.DrawString("Start :" + " _____________________", font1, Brushes.Black, 405, 1175)
                e.Graphics.DrawString(" End : " + "_____________________", font1, Brushes.Black, 405, 1205)
            Else
                e.Graphics.DrawString("   • WORK IMMERSION", font1, Brushes.Black, 60, 1175)
                e.Graphics.DrawString("Start : " + DateTimePicker1.Text, font1, Brushes.Black, 450, 1175)
                e.Graphics.DrawString(" End : " + DateTimePicker1.Text, font1, Brushes.Black, 450, 1205)
                e.Graphics.DrawString(TextBox63.Text, font1, Brushes.Black, 655, 1195)
                e.Graphics.DrawString(TextBox64.Text, font1, Brushes.Black, 750, 1195)
    ...
    Private Sub TextBox4_MouseEnter(sender As Object, e As EventArgs) Handles TextBox4.MouseEnter
        If TextBox4.Text = " PLEASE DO NOT ABBREVIATE THE FULL NAME OF YOUR SCHOOL" Then
            TextBox4.Text = ""
    ...
    Private Sub TextBox4_MouseLeave(sender As Object, e As EventArgs) Handles TextBox4.MouseLeave
        ...
        If TextBox4.Text = "" Then
            TextBox4.Text = " PLEASE DO NOT ABBREVIATE THE FULL NAME OF YOUR SCHOOL"
            TextBox4.ForeColor = Color.Gray
        End If
    End Sub

    Private Sub ComboBox1_MouseEnter(sender As Object, e As EventArgs) Handles ComboBox1.MouseEnter
        If ComboBox1.Text = "Select Your Region" Then
            ComboBox1.Text = ""
    ...
    Private Sub TextBox61_MouseEnter(sender As Object, e As EventArgs) Handles TextBox61.MouseEnter
    ...
    Private Sub TextBox61_MouseLeave(sender As Object, e As EventArgs) Handles TextBox61.MouseLeave
    ...
    Private Sub TextBox62_MouseEnter(sender As Object, e As EventArgs) Handles TextBox62.MouseEnter
    ...
    Private Sub TextBox62_MouseLeave(sender As Object, e As EventArgs) Handles TextBox62.MouseLeave
        If TextBox61.Text = "2017" Then
            TextBox61.Text = ""
            TextBox61.ForeColor = Color.Gray
        End If
    End Sub
